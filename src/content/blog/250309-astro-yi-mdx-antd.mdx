...
<Image
    ...
    width={200}
    height={200}
    src="https://github.com/user-attachments/assets/36d9d41a-cce6-4948-ae81-3973095db269"
  /> 
...
- 사용할 AntD. 컴포넌트를 import합니다. ( https://ant.design/components/overview에서 사용가능한 컴포넌트를 확인 할 수 있습니다. )
```
import { Image } from "antd";
```
<Image
...
- Component를 사용하여 글을 작성합니다.
  - 사용시 <div stype="color:darkred">"client:load"</div> Astro Directives를 설정해 클릭 이벤트가 정상적으로 작동 합니다. (https://docs.astro.build/en/reference/directives-reference/)
```
<Image
    client:load
    width={200}
